        ...
        <>
            <form onSubmit={submitHandler}>
                ...
                <button
                    ...
                    className="shadow disabled:bg-gray-500 bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded mt-3"
                    type="submit"
                >
                    Изменить
                </button>
